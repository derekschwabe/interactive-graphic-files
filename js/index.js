...
$('#bread-line-graph').highcharts({
  ...
  credits: {
      ...
      href: 'http://www.cdc.gov/nchs/products/databriefs/db241.htm',
      style:{
        fontFamily: 'Calibri',
        fontSize: '10pt',
        color: "gray"
  ...
  title: {
    text: 'U.S. Suicide Rates Reach 30-Year High',
    useHTML: true,
    margin: 5, 
    align: 'left',
    y: 10,
  ...
  subtitle: {
    text: '<i>Age-adjusted suicide rates, by sex: 1999&#45;2014</i>',
    useHTML: true, 
    margin: 0,
    y: 27,
    align: 'left',
  ...
  xAxis: {
    categories: ['2000', '2002', '2004', '2006', '2008',
    '2010', '2012', '2014'
    ]
  },
  yAxis: {
  ...
  series: [{
    name: 'Male',
    data: [17.7, 18.5, 18.1, 18.1, 19.0, 19.8, 20.4, 20.4]
  }, {
    name: 'Total',
    data: [10.4, 10.9, 11.0, 11.0, 11.6, 12.1, 12.6, 13.0]
  }, {
    name: 'Female',
    data: [4.0, 4.2, 4.5, 4.5, 4.8, 5.0, 5.4, 5.8]
  }
  ]
},
...
// Rendering the Bread for the World Logo
 ...
 function (chart) { // on complete
        ...
        var top = chart.plotTop + chart.plotHeight - 300, 
