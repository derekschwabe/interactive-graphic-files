...
$('#bread-line-graph').highcharts({
  ...
  credits: {
      enabled: true,
      text: 'SOURCE: Paul T. von Hippel et al., American Journal of Public Health',
      href: 'http://www.ncbi.nlm.nih.gov/pmc/articles/PMC1829359/',
      style:{
        fontFamily: 'Calibri',
        fontSize: '10pt',
        color: "gray"
  ...
  title: {
    text: 'Child obesity sees sharp rise during summer',
    useHTML: true,
    margin: 5, 
    align: 'left',
    y: 10,
...
// Rendering the Bread for the World Logo
 ...
 function (chart) { // on complete
        ...
        left = chart.plotLeft + chart.plotWidth - 160;
