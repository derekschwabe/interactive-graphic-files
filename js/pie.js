...
$('#bread-line-graph').highcharts({
  ...
  credits: {
      enabled: true,
      text: 'SOURCE: Global Nutrition Report, 2016',
      href: 'http://www.globalnutritionreport.org',
      style:{
        fontFamily: 'Calibri',
        fontSize: '10pt',
        color: "gray"
  ...
  title: {
    text: 'Country Progress on 2025 Stunting Target',
    useHTML: true,
    margin: 5, 
    align: 'left',
    y: 10,
  ...
  subtitle: {
    text: '<i>Number of countries in each of four progress groups in 2015</i>',
    useHTML: true, 
    margin: 0,
    y: 27,
    align: 'left',
    ...
    borderWidth: 0
          ...
          series: [{
            ...
            data: [{
                ...
                name: 'On course, little/no progress',
                y: 15
            }]
        }]},
...
// Rendering the Bread for the World Logo
 ...
 function (chart) { // on complete
        ...
        var top = chart.plotTop + chart.plotHeight - 322, 
